...
const (
    ...
    merchantPIDLoaderKey key = "merchantPID"
    brandLoaderKey       key = "brand"
    productLoaderKey     key = "product"
    merchantLoaderKey    key = "merchantLoaderKey"
)
...
func NewLoaderCollection() LoaderCollection {
    return LoaderCollection{
        dataloaderFuncMap: map[key]dataloader.BatchFunc{
            ...
            merchantPIDLoaderKey: newMerchantsPIDLoader(),
            brandLoaderKey:       newBrandsLoader(),
            productLoaderKey:     newProductsLoader(),
            merchantLoaderKey:    newMerchantsLoader(),
        },
    }
}
